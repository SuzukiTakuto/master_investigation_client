...
val lodLevelGroup1: List<LODLevel> = listOf(
    LODLevel(1, 0.029791176.toFloat(), 411924, 0.19438033f, 100f, false),
    LODLevel(2, 0.029098812.toFloat(), 596667, 0.2815576f, 100f, false),
    LODLevel(3, 0.02444897.toFloat(), 679431, 0.32061258f, 100f, false),
...
val lodLevelGroup2: List<LODLevel> = listOf(
    LODLevel(1, 0.989185619.toFloat(), 78197, 0f, 100f, false),
    LODLevel(2, 0.981951954.toFloat(), 126957, 0f, 100f, false),
    LODLevel(3, 0.974212655.toFloat(), 169142, 0f, 100f, false),
    LODLevel(4, 0.948414992.toFloat(), 316330, 0f, 100f, false),
    LODLevel(5, 0.871011681.toFloat(), 688620, 0f, 100f, false),
    LODLevel(6,0.57000454.toFloat(), 1694699, 0f, 100f, false),
    LODLevel(7, 0f, 3464545, 0f, 100f, false)
)
